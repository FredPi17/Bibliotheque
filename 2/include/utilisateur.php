...
if(isset($_POST['connexion']))
  ...
  <head>
    ...
    <link rel="stylesheet" href="style/css/feature-carousel.css" charset="utf-8" />
    ...
    <div class="carousel-container">
      ...
      <div id="carousel">
        <div class="carousel-feature">
          <a href="#"><img class="carousel-image" alt="Image Caption" src="image/1.jpg"></a>
          <div class="carousel-caption">
            <p>
             <!-- Titre du livre a compléter-->
            </p>
          </div>
        </div>
        <div class="carousel-feature">
          <a href="#"><img class="carousel-image" alt="Image Caption" src="image/2.jpg"></a>
          <div class="carousel-caption">
            <p>
              <!--Titre du livre a compléter-->
            </p>
        ...
        <div class="carousel-feature">
          <a href="#"><img class="carousel-image" alt="Image Caption" src="image/3.jpg"></a>
          <div class="carousel-caption">
            <p>
             <!-- Titre du livre a compléter-->
            </p>
        ...
        <div class="carousel-feature">
          <a href="#"><img class="carousel-image" alt="Image Caption" src="image/4.jpg"></a>
        </div>
      </div>

      <div id="carousel-left"><img src="image/arrow-left.png" /></div>
      <div id="carousel-right"><img src="image/arrow-right.png" /></div>
    </div>
  </body>
</html>
';
